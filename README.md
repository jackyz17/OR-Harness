...
- **Two-layer memory**: an append-only **Experience Bank** (episodic facts) and a derived **Strategic Bank** (calibrated commitments with prediction intervals and forward validation). Statistics are computed on the fly, never persisted.
