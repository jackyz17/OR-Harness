...
- **[references/episode_closeout.md](references/episode_closeout.md)** — the episode close-out (world-model M4): real outcome summaries, per-field post-hoc evaluation, window selection rounds, the experience calibration channel (with a runnable example)
